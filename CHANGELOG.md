...
- Add chat toolbar [#12](https://github.com/QuantStack/jupyter-ai-tutor/pull/12) ([@brichet](https://github.com/brichet))
- UI/UX improvements [#11](https://github.com/QuantStack/jupyter-ai-tutor/pull/11) ([@brichet](https://github.com/brichet))
...
- Add the previous markdown cell as context [#9](https://github.com/QuantStack/jupyter-ai-tutor/pull/9) ([@brichet](https://github.com/brichet))
- Explain errors if the cell output contains some [#4](https://github.com/QuantStack/jupyter-ai-tutor/pull/4) ([@brichet](https://github.com/brichet))
- Use an AGENT.md file [#3](https://github.com/QuantStack/jupyter-ai-tutor/pull/3) ([@brichet](https://github.com/brichet))
- Dedicated chat panel [#2](https://github.com/QuantStack/jupyter-ai-tutor/pull/2) ([@brichet](https://github.com/brichet))

### Maintenance and upkeep improvements

- Add jupyter-builder dependency before building npm [#10](https://github.com/QuantStack/jupyter-ai-tutor/pull/10) ([@brichet](https://github.com/brichet))
- Install servers dependencies in myBinder [#5](https://github.com/QuantStack/jupyter-ai-tutor/pull/5) ([@brichet](https://github.com/brichet))
- Fix tests [#1](https://github.com/QuantStack/jupyter-ai-tutor/pull/1) ([@brichet](https://github.com/brichet))

### Documentation improvements

- Add an example [#6](https://github.com/QuantStack/jupyter-ai-tutor/pull/6) ([@brichet](https://github.com/brichet))
...
([GitHub contributors page for this release](https://github.com/QuantStack/jupyter-ai-tutor/graphs/contributors?from=2026-06-08&to=2026-06-16&type=c))

@brichet ([activity](https://github.com/search?q=repo%3AQuantStack%2Fjupyter-ai-tutor+involves%3Abrichet+updated%3A2026-06-08..2026-06-16&type=Issues))
